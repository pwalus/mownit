...
int main() {
    ...
    FILE *handle = fopen("first_function.txt", "w");
    FILE *handle10 = fopen("first_function_czebyszew_10.txt", "w");
    FILE *handle20 = fopen("first_function_czebyszew_20.txt", "w");
    FILE *handle30 = fopen("first_function_czebyszew_30.txt", "w");
    FILE *handle40 = fopen("first_function_czebyszew_40.txt", "w");
